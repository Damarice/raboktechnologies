                ...
                <div className="row">
                    <div className="col-xl-5 col-lg-6 d-flex align-items-center">
                        <div className="tekup-default-content">
                            <h2>Ready to make data your competitive advantage?</h2>
                            <p>Whether you are just starting your data journey or looking to take your BI capability to the next level, we would love to hear from you. Book a free strategy call and let us show you what is possible.</p>
                    ...
                    <div className="col-xl-6 offset-xl-1 col-lg-6">
                        <div className="tekup-main-form">
                            ...
                            <p>One of our senior BI consultants will be in touch within 24 hours.</p>
                            <form action="#">
                                <div className="row">
